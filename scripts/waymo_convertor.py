...
class Waymo2KITTI(object):
    ...
    def convert(self):
        ...
        with Pool(self.workers) as pool:
            list(tqdm(pool.imap(self.convert_one, range(len(self))), total=len(self)))
        print('\nFinished ...')
    ...
    def save_image(self, frame, file_idx, frame_idx):
        ...
        """
        image_save_dir = f'{self.save_dir}/{self.prefix}'+f'{str(file_idx).zfill(3)}/image_'
    ...
    def save_calib(self, frame, file_idx, frame_idx):
        ...
        Args:
            ...
            frame_idx (int): Current frame index.
        """
        calib_save_dir = f'{self.save_dir}/{self.prefix}'+f'{str(file_idx).zfill(3)}/calib'
    ...
    def save_lidar(self, frame, file_idx, frame_idx):
        ...
        Args:
            ...
            frame_idx (int): Current frame index.
        """
        point_cloud_save_dir = f'{self.save_dir}/{self.prefix}'+f'{str(file_idx).zfill(3)}/velodyne'
        ...
        pc_path = f'{point_cloud_save_dir}/{self.prefix}' + \
    ...
    def save_label(self, frame, file_idx, frame_idx):
        ...
        Args:
            ...
            frame_idx (int): Current frame index.
        """
        label_save_dir = f'{self.save_dir}/{self.prefix}'+f'{str(file_idx).zfill(3)}/label_'
        label_all_save_dir = f'{self.save_dir}/{self.prefix}'+f'{str(file_idx).zfill(3)}/label_all'
        fp_label_all = open(
            f'{label_all_save_dir}/{self.prefix}' +
        ...
        for obj in frame.laser_labels:
            ...
            fp_label = open(
                f'{label_save_dir}{name}/{self.prefix}' +
    ...
    def save_pose(self, frame, file_idx, frame_idx):
        ...
        Args:
            ...
            frame_idx (int): Current frame index.
        """
        pose_save_dir = f'{self.save_dir}/{self.prefix}'+f'{str(file_idx).zfill(3)}/pose'
        pose = np.array(frame.pose.transform).reshape(4, 4)
        np.savetxt(
            join(f'{pose_save_dir}/{self.prefix}' +
                 f'{str(file_idx).zfill(3)}{str(frame_idx).zfill(3)}.txt'),
            pose)
    ...
    def save_timestamp(self, frame, file_idx, frame_idx):
        ...
        Args:
            ...
            frame_idx (int): Current frame index.
        """
        timestamp_save_dir = f'{self.save_dir}/{self.prefix}'+f'{str(file_idx).zfill(3)}/timestamp'
        with open(
                join(f'{timestamp_save_dir}/{self.prefix}' +
                     f'{str(file_idx).zfill(3)}{str(frame_idx).zfill(3)}.txt'),
                'w') as f:
            f.write(str(frame.timestamp_micros))

    def create_folder(self, file_idx):
        ...
        timestamp_save_dir = f'{self.save_dir}/{self.prefix}'+f'{str(file_idx).zfill(3)}/timestamp'
        dir_list1 = [
            label_all_save_dir, calib_save_dir,
            point_cloud_save_dir, pose_save_dir,
            timestamp_save_dir
        ]
        dir_list2 = [label_save_dir, image_save_dir]
